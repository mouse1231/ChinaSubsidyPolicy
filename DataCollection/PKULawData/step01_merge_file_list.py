...
if __name__ == '__main__':
    file_list = os.listdir(os.path.join(ROOT_PATH, 'data', 'pkulaw'))
    ...
    for f in file_list:
        ...
        df: DataFrame = pd.read_excel(os.path.join(ROOT_PATH, 'data', 'pkulaw', f), skiprows=2).iloc[:-2]
    ...
    result_df.to_pickle(os.path.join(ROOT_PATH, 'temp', '20210117_all_file_list.pkl'))
    agency_df.to_excel(os.path.join(ROOT_PATH, 'temp', '20210117_agency_list.pkl'))
